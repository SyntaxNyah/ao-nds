...
void UICourtEvidence::init()
{
	...
	btn_present = new UIButton(&oamSub, "/data/ao-nds/ui/spr_present", btn_back->nextOamInd(), 3, 1, SpriteSize_32x32, 128-(85/2), 0, 85, 32, 32, 32, 1);
	btn_pageLeft = new UIButton(&oamSub, "/data/ao-nds/ui/spr_pageLeft_tall", btn_present->nextOamInd(), 1, 3, SpriteSize_16x32, 4, 55, 16, 95, 16, 32, 2);
